<div class="headerbar">
	<div class="clearfix">
		...
		if(count($aboutus) == 0){
		?>
		<a class="btn btn-primary pull-right" href="<?php echo site_url('admin/captions/form/aboutus'); ?>">
...
<table class="table table-bordered datatable data_table">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a class="btn btn-primary edit btn-sm" href="<?php echo site_url('admin/captions/form/' . $q->id.'/aboutus'); ?>">
					<i class="entypo-pencil"></i>
				</a>
				<a class="btn btn-danger btn-sm" href="<?php echo site_url('admin/captions/delete/' . $q->id); ?>" onclick="return confirm('<?php echo lang('delete_record_warning'); ?>');" >
