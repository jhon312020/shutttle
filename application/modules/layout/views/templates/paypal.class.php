<?php
    ...
    class MyPayPal {
        ...
        function SetExpressCheckout($products, $charges, $noshipping='1'){
            ...
            $padata .=  '&PAYMENTREQUEST_0_CUSTOM='.$products[0]['BookId'];
        ...
        function DoExpressCheckoutPayment(){
            ...
            if(!empty($ppl_products)&&!empty($ppl_charges)) {
                ...
                if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])){
                    $transaction_arrray = array('transaction'=>1, 'response'=>$httpParsedResponseAr);
                    return $transaction_arrray;
                } else {
                        $transaction_arrray = array('transaction'=>0, 'response'=>$httpParsedResponseAr);
                        return $transaction_arrray;
                }
            }
        }
