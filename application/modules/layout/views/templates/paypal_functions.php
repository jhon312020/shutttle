<?php
	...
	********************************************/
	...
	require(APPPATH . 'modules/layout/views/templates/paypal_config.php');
	...
	*/
	function CallShortcutExpressCheckout( $paramsArray, $returnURL, $cancelURL) 
	{
		...
		//echo "<pre";print_r($paramsArray);echo "</pre>";exit;
		...
		*/
	    ...
	    //echo "<pre>";print_r($resArray);echo"</pre>";exit;
