...
?>
	...
	?>
	<div class="banner" style="background-image:url(<?php echo $template_path; ?>/images/aboutus.jpg);">
		<p>Pick'n Go</p>
...
$('.aboutusimg img').css('width', '100%');
$('.aboutusimg img').closest('div').removeClass('col-lg-6').addClass('col-lg-12');
</script>
