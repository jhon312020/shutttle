<?php
   ...
   require_once(APPPATH . 'modules/layout/views/templates/paypal_functions.php');
   ...
   //include(APPPATH . 'modules/layout/views/templates/header.php');
?>
<!--
   <div class="span4">
   </div>
   <div class="span5"> -->
            ...
            <!-- <form class="form" action="../node/paypal_ec_mark" method="POST">
               <div class="row-fluid">
