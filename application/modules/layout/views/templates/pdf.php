			...
			<tbody>
				...
				<tr style="width:100%;margin:0px!important;padding:0px!important;">
					...
					<td style="width:48%;padding-right:15px;background-color:#fff;background-color:#fff;">
						...
						<p style="padding-bottom:20px;">
							<span style="font-size:18px;padding-left:10px;color:#25387d;vertical-align:middle;font-weight:bold;"><?php echo lang('address'); ?>:</span>  <span style="font-size:18px;color:#25387d;vertical-align:middle;"><?php echo $bookings['address']; ?></span>
						</p>
						<?php } ?>
						</div>
