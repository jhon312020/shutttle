    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="http://localhost/shutttle/assets/cc/images/slider.jpg" alt="First slide">
          <div class="container">
        ...
        <div class="item">
          <img class="second-slide" src="http://localhost/shutttle/assets/cc/images/slider.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
              <p>The best transport between </br>Barcelona Airport and your hotel</p>
              <p><a class="btn btn-lg" href="#" role="button">BOOK NOW</a></p>
