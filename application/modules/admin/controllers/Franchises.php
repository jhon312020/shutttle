...
class Franchises extends Admin_Controller {
    ...
    {
        $this->layout->set(array('franchises'=>$this->mdl_captions->where(array('type' => 'franchises'))->order_by('created', 'desc')->get()->result(), 'path'=>$this->path, 'caption_path' => $this->caption_path));
        $this->layout->buffer('content', 'franchises/index');
        $this->layout->render();
    }
